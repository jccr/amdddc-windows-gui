...
A simple Windows GUI utility to issue the switch input command via DDC to a monitor connected to an AMD GPU.

Looking for a macOS version? Check out [ddc-input-switcher-macos](https://github.com/jccr/ddc-input-switcher-macos).
